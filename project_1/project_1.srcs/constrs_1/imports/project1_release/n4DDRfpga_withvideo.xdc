...
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { SDO }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
# set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { SDI }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
...
##Pmod Header JB
 ...
 set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { pulse_signal }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
# set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { HCSR04_trig }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
# set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { SDI }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
