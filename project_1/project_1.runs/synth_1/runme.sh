...
HD_PWD='C:/Users/Thanh/Desktop/OV7670_With_VGA/HC_SR04/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Nexys4_top.tcl
