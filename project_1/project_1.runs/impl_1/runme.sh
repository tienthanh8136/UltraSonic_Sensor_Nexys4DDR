...
HD_PWD='C:/Users/Thanh/Desktop/OV7670_With_VGA/HC_SR04/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Nexys4_top.tcl -notrace
